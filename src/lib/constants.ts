...
export const pricingCards = [
  {
    title: 'Starter',
    description: 'Perfect for trying out savar',
    price: 'Free',
    duration: '',
  ...
  },
  {
    ...
    priceId: 'price_1OiEQSDAEBsbA0Y2rGC2AiW9',
  },
  {
    title: 'Basic',
  ...
  },
  {
    ...
    duration: 'month',
    highlight: 'Everything in Starter, plus',
    features: ['All in one and more'],
    priceId: 'price_1Oji1MDAEBsbA0Y2gFkfP75O',
  },
]

export const addOnProducts = [
  { title: 'Priority Support', id: 'prod_PXJHRIpycyXRac' },
]
